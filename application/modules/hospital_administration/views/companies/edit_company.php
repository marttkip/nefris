                                ...
                                <div class="col-lg-8">
                                    <?php
                                        ...
                                        else
                                        {
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input id="optionsRadios1" type="radio"  value="1" name="insurance_company_status">
                                                    Yes
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input id="optionsRadios2" type="radio" checked value="0" name="insurance_company_status">
                                                    No
                                                </label>
                                            </div>
                                            <?php
