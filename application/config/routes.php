...
$route['cashier/orders'] = 'inventory/orders/index';
$route['orders'] = 'inventory/orders/index';




$route['cashier'] = 'inventory/orders/index';

/*
*	doctor Routes
*/
$route['reports'] = 'reports/index';
$route['reports/all-transactions'] = 'cashier/reports/all_reports/admin';
$route['reports/cash-report'] = 'cashier/reports/cash_report/admin';
$route['reports/cash-report/(:num)'] = 'administration/reports/cash_report/$1';
$route['reports/debtors-report'] = 'administration/reports/debtors_report/0';


$route['inventory/validate-import'] = 'inventory/do_drugs_import';
$route['inventory/import-template'] = 'inventory/import_template';
$route['inventory/import-drugs'] = 'inventory/import_drugs';